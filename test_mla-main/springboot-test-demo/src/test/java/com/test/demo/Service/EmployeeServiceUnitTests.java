...
import com.test.demo.Service.Impl.EmployeeServiceImpl;
...
public class EmployeeServiceUnitTests {
    ...
    public void setup(){
        ...
        employee = new Employee(1L, "Rohit", "sharma", "rohit@gmail.com");
    ...
    public void getAllEmployee(){
        Employee employee1 = new Employee(1L, "Rohit", "sharma", "rohit@gmail.com");
    ...
    public void updateEmployee(){
        ...
        assertThat(updatedEmployee.getEmail()).isEqualTo("rohit@gmail.com");
        assertThat(updatedEmployee.getFirstName()).isEqualTo("Rohit");
    }
